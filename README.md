...
This repository contains the audited legal research and Phase 0 controls for **Digital Ground Game (DGG)** concerning a private, voluntary, opt-in format that separates narrowly defined sworn factual statements from ordinary unsworn political commentary.

## Status

**Research audit complete; not launch-cleared.** The canonical memorandum recommends only a counsel-reviewed synthetic dry run followed, if all gates pass, by a small nonlive pilot. Nothing here is legal advice or a substitute for Washington, participant-state, media/privacy, campaign-law, or notarial review.
...
Washington provides enough notarial infrastructure for DGG to test a fixed, voluntary sworn-record format. During 2026, the conservative remote design is a defined electronic record that the participant reviews, signs, and swears or affirms is true through a compliant Washington remote-notary workflow. Enacted law expressly adds a standalone remote oath/affirmation procedure beginning January 1, 2027, subject to a fresh rule and guidance check.
